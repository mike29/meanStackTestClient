...
$(document).ready(function() {
  ...
  $('#svgImage').click(function(e){
    ...
    console.log("radio:" + document.getElementById('createElement').checked);
    console.log("type" + document.getElementById('selectType').value);
  ...
  $("#svgCanvas").click(function(e){
    ...
    if(elementMouseIsOver !== "svgImage") {
      if(document.getElementById("deleteElement").checked){
